...
a standard framework for writing benchmarks. ======= <<<<<<< HEAD The tests are
based on [Google Benchmark](https://github.com/google/benchmark) library, which
provides a standard framework for writing benchmarks.
...
# _Note: Google Benchmark `1.6.x` is incompatible with previous versions like `1.5.x`, please make sure you're using the newer version._
...
<<<<<<< HEAD _Note: Google Benchmark `1.6.x` is incompatible with previous
versions like `1.5.x`, please make sure you're using the newer version._ =======
Install the [Google Benchmark](https://github.com/google/benchmark) version
`1.6.0` or above.
