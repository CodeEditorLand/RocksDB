...
for cf_name in "all"; do
	for cache_size in "1G" "2G" "4G" "8G" "16G"; do                                        #"12G" "16G" "1T"
		for cache_type in "opt" "lru" "pylru" "pycctbbt" "pyhb" "ts" "trace" "lru_hybrid"; do #"pycctblevelbt" #"lru_hybridn" "opt" #"pylru" "pylru_hybrid" "pycctbbt" "pycccfbt" "trace"
...
for header in "header-" "data-"; do
	for fn in "$ml_tmp_result_dir"/*; do
		sum_file=""
		time_unit=""
		capacity=""
		target_cf_name=""
